  ...
  render() {
    ...
    return (
      <>
        ...
        <header className="App-header">{match.params.infinitive}</header>

        <p>{this.state.verbEntries[0].infinitive_english}</p>

        <Paper>
          <h2>Test Form Table</h2>
          <FormTable
            data={getMood(this.state.verbEntries, "Indicativo")}
          />
        </Paper>
        ...
        <Paper>
          ...
          <SubjuntivoTable
            data={getMood(this.state.verbEntries, "Subjuntivo")}
          />
        </Paper>
        ...
        <Paper>
          ...
          <ImperativoTable
            afirmativo={getMood(
              this.state.verbEntries,
              "Imperativo Afirmativo"
            )}
            negativo={getMood(this.state.verbEntries, "Imperativo Negativo")}
          />
        </Paper>
      </>
    );
